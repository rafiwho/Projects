...
class GitGUI:
    ...
    def push_changes(self):
        try:
            self.repo.git.push()  # Push changes to remote
    ...
    def clone_repo(self):
        # Prompt for the GitHub URL based on SSH/HTTPS selection
        repo_url = simpledialog.askstring("Clone Repository", f"Enter the Git {self.clone_type.get()} URL of the repository:")
        if repo_url:
